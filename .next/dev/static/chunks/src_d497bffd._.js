...
const Footer = ()=>{
    ...
    const handleSubscribe = async (e)=>{
        ...
        setStatus('loading');
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/api/subscribers', {
                email
            });
            setStatus('success');
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success('Welcome to the Inner Circle.');
            setEmail('');
        } catch (err) {
            console.error(err);
...
_s(Footer, "4e7CyTvSIXKg0XJWYe8bTLqSzlM=");
_c = Footer;
...
//# sourceMappingURL=src_d497bffd._.js.map