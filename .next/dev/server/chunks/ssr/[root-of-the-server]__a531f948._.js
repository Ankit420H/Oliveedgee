...
const LoginContent = ()=>{
    ...
    const [errors, setErrors] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])({}); // Granular error state
    const [authError, setAuthError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null); // Auth error state
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        if (reason === 'session_expired') {
            // Need to handle search params update slightly differently in Next.js/Server components
            ...
            // In Next.js, we can replace the URL without reload using router.replace
            // Construct new URL without the 'reason' param
            const newParams = new URLSearchParams(searchParams.toString());
            newParams.delete('reason');
        // router.replace(`/login?${newParams.toString()}`); // Optional cleanup
        }
    }, [
        searchParams,
        router
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a531f948._.js.map