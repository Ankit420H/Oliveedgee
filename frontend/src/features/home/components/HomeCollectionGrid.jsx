        ...
        <section className="py-24 bg-clinical-canvas">
            <div className="container mx-auto px-6">
                ...
                <div className="flex items-end justify-between mb-16">
                    ...
                    <a href="/shop" className="hidden md:flex items-center justify-center w-24 h-24 rounded-full border border-clinical-ink/20 hover:border-black transition-colors group">
                ...
                <div className="flex md:hidden justify-center mt-12">
                    <a href="/shop" className="px-8 py-3 rounded-full border border-clinical-ink/20 font-sans text-xs font-bold uppercase tracking-widest">
                        View All
                    </a>
                </div>
