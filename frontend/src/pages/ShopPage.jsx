...
const ShopPage = () => {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                ...
                const uniqueCategories = ['All', ...new Set((data.products || data).map(item => item.category))];
    ...
    return (
        <div className="bg-clinical-canvas min-h-screen pt-32 pb-40">
            <Helmet>
                <title>Shop | Olive Edge</title>
                <meta name="description" content="Explore our collection of premium apparel." />
            </Helmet>
