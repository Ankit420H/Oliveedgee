                ...
                <div className="mx-auto px-container-sm md:px-container-md lg:px-container-lg relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-12 font-sans text-sm font-medium tracking-wide">
                        ...
                        <div className="flex flex-col gap-6">
                            ...
                            <Link href="/shop" className="hover:text-white/70 transition-colors">Shop All</Link>
                            <Link href="/about" className="hover:text-white/70 transition-colors">Philosophy</Link>
                            <Link href="/journal" className="hover:text-white/70 transition-colors">Journal</Link>
                            <Link href="/stores" className="hover:text-white/70 transition-colors">Locations</Link>
                        </div>

                        {/* Column 2 */}
                        <div className="flex flex-col gap-6">
                            <span className="text-xs uppercase tracking-widest text-gray-400 mb-2">Support</span>
                            <Link href="/profile" className="hover:text-white/70 transition-colors">My Personnel File</Link>
                            <Link href="/contact" className="hover:text-white/70 transition-colors">Contact Ops</Link>
                            <Link href="/faq" className="hover:text-white/70 transition-colors">FAQs</Link>
                            <Link href="/delivery" className="hover:text-white/70 transition-colors">Shipping Protocols</Link>
                        </div>

                        {/* Column 3 */}
                        <div className="flex flex-col gap-6">
                            <span className="text-xs uppercase tracking-widest text-gray-400 mb-2">Legal</span>
                            <Link href="/privacy" className="hover:text-white/70 transition-colors">Privacy Directive</Link>
